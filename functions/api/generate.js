...
export async function onRequestPost(context) {
  ...
  const system = isAbsurd
    ...
    : "너는 한국어 거절 메시지를 대신 써주는 도우미야. 핵심 원칙: " +
      ...
      "특히 '테토남 스타일'은 한국 친한 남사친 특유의 말투: ㅋㅋ 치면서 툭 던지는 가벼운 거절, 진지하게 거절하는 게 아니라 장난처럼 무시해버리는 느낌, 위로나 사과 없이 그냥 '됐고', '되겠냐', '잠이나 자라', '꿈 깨' 같은 반응. 차갑지는 않지만 쿨하게 선 긋는 한국 남자들만 아는 그 텐션. 이모티콘 ㅋㅋ, ㅋ, ㄴㄴ 자연스럽게 섞어도 됨. " +
