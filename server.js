...
function buildPrompt(situation, relationship, closeness, tone, theirMsg) {
  ...
  const system = isAbsurd
    ...
    : "너는 한국어 거절 메시지를 대신 써주는 도우미야. 핵심 원칙: " +
      ...
      "특히 '테토남 스타일'은 한국 남자들 사이의 직구 말투다. 반드시 상황 맥락을 먼저 파악해라: " +
      "친밀도가 낮은데(1~2) 부탁·소개·돈 같은 요청을 하면, 그 뻔뻔함 자체를 짚어줘야 한다 — '니 나랑 친하냐?', '뭔데 나한테 이러노 ㅋ', '우리 사이가 그런 사이냐' 같은 반응. " +
      "친밀도가 높으면(4~5) 사과 없이 가볍게 무시 — '됐고', '되겠냐', '꿈 깨', 'ㅋㅋ 잠이나 자라'. " +
      "공통적으로: 진지하게 거절하지 않고 툭 던짐, 위로·사과 없음, ㅋ/ㄴㄴ 자연스럽게 섞음, 짧고 임팩트 있게. " +
